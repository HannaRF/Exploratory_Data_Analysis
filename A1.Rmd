...
kable( data.frame( Tabela %>% count(animal)) )
...
kable( data.frame( Tabela %>% count(furniture)) )
...
kable( data.frame( Tabela %>% count(city)) )
...
kable( data.frame( Tabela %>% count(rooms)) )

kable( data.frame( Tabela %>% count(bathroom)) )

kable( data.frame( Tabela %>% count(parking.spaces)) )
