...
<br>  
Vamos verificar as frequências dae algumas variáveis categóricas  
...
#  Gráficos para entradas unidimensionais.  
...
Vamos criar uma nova coluna "preço_ relativo_m2" obtida pela razão entre o total em valor e a área. Vejamos os que possuemo $m^2$ acima de R$200,00.  
...
estruturas de dados categŕicos.Usei `patchwork` para juntar gráficos distintos.  
