...
# Medidas  
<br>  
O imóvel médio da nossa base aceita animais, é da cidade 1 e não vem com mobília.  
...
## Proporções conjuntas {.tabset}  
<br> 
Casas sem mobília geralmente são mais tolerantes com animais, o que é razoável de se pensar, pois animais podem arranhar e danificar a mobília.  
...
## Resumo e dispersão {.tabset} 
<br>  
Algumas variáveis apresentam uma variância relativamente alta como vagas de garagem, quatos e aluguel. Número de quartos no entanto teve uma variância relativamente baixa indicando maior regularidade.  
